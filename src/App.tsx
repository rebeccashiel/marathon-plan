  ...
  return (
    <div>
      <div style={{display:'flex',background:'#000',padding:'8px 12px',gap:6,position:'sticky',top:0,zIndex:100}}>
        ...
        <button onClick={()=>setView('block3')} style={{flex:1,padding:'9px 4px',borderRadius:8,border:'none',background:view==='block3'?'#30d158':'#1c1c1e',color:'#fff',fontSize:11,fontWeight:700,cursor:'pointer'}}>Wks 9–12</button>
